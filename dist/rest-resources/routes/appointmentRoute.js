...
router.post('/', authorizeRoles('patient'), validationMiddleware(appointmentSchema), appointmentController.createAppointment);
...
router.put('/:id', authorizeRoles('patient', 'doctor', 'admin'), validationMiddleware(appointmentUpdateSchema), appointmentController.updateAppointment);
